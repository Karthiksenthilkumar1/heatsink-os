...
class StatusHeader(QFrame):
    ...
    def add_control_button(self, btn):
        """
        Adds a control button to the top row, before metrics.
        """
        # We find the index of mini_metric or just add it before the end
        self.top_row.insertWidget(self.top_row.count() - 1, btn)
